...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "**✶ الحساب المساعد موجود مسبقًا**")


@Client.on_message(
    command(["userbotleave", f"غادر", "lv"]) & other_filters
)
@authorized_users_only
...
async def leave_all(client, message):
    ...
    msg = await message.reply("🔄 جار مغادرة جميع المجموعات بطلب من المطور !")
